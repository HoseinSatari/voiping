                        ...
                        <tbody>
                             @foreach($calls as $call)
                                <tr>
                                    ...
                                    <td  class="text-align-center">{{jdate($call->created_at)->format('Y-%m-%d H:i:s')}}</td>
                                    <td  class="text-align-center">{{$call->customers->phone}}</td>
                                    <td  class="text-align-center"><a href="{{route('calls.user' , $call->customers->id)}}">{{$call->customers->name}}</a></td>
